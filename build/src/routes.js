...
const user__controller_1 = require("./controller/user..controller");
...
function routes(app) {
    ...
    app.post('/api/users', (0, validateResource_1.default)(user_schema_1.createUserSchema), user__controller_1.createUserHandler);
    ...
    // products routes
    app.post('/api/products', [requireUser_1.default, (0, validateResource_1.default)(product_schema_1.createProductShema)], product_controller_1.createProductHandler);
